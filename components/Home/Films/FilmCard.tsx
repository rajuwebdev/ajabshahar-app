  ...
  return (
    <div className="bg-white card-rounded-4 shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="p-5 card-shape-top pt-1 pb-0">
        <div className="mb-2">
          <h3 className="card-heading font-semibold mb-1">{filmData.metaTitle}</h3>
          {filmData.subtitle && (
            <p className="text-sm lora-italic mb-2 semi-heading">{filmData.subtitle}</p>
          )}
          {filmData.director && (
        ...
        <p className="card-text leading-relaxed mb-4 border-top-pink">{filmData.metaDescription}</p>
